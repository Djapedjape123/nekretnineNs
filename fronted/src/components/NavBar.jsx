                ...
                <div className="md:hidden bg-black/95 border-t border-yellow-500 text-white">
                    <nav className="flex flex-col p-4 gap-4">
                        ...
                        <div className="flex gap-4 pt-2">
                            <button className='text-white' onClick={() => changeLang('sr')}>🇷🇸</button> {/* Srbija */}
                            <button className='text-white' onClick={() => changeLang('ru')}>🇷🇺</button> {/* Rusija */}
                            <button className='text-white' onClick={() => changeLang('en')}>🇺🇸</button> {/* SAD (Zvezdice i pruge) */}
                        </div>
                    </nav>
                </div>
            )}
